var bbbPath =
  'https://ms-f7-sites-01-cdn.azureedge.net/docs/stories/841638-b3-banking-capital-markets-azure-pt-brazil/resources/69f88dab-5e21-4d16-a825-d37b533f7d17/1279531361655909744_1279531361655909744'
...
var sketch = function (p) {
  ...
  p.setup = function () {
    ...
    var bbb = p.loadImage(bbbPath, function (img) {
      // p.image(img, 0, 0);
      bbb.resize(smallSize, smallSize)
      bbb.loadPixels()
      for (var x = 0; x < bbb.width; x++) {
        for (var y = 0; y < bbb.height; y++) {
          var index = (x + y * bbb.width) * 4
          if (bbb.pixels[index] < 200) {
